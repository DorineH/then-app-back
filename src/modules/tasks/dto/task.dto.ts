...
@ApiProperty({ enum: ['travail', 'perso', 'rdv', 'autre'], example: 'perso' })
@IsIn(['travail', 'perso', 'rdv', 'autre'])
category!: 'travail' | 'perso' | 'rdv' | 'autre';
...
@ApiPropertyOptional({ enum: ['travail', 'perso', 'rdv', 'autre'] })
@IsOptional()
@IsIn(['travail', 'perso', 'rdv', 'autre'])
category?: 'travail' | 'perso' | 'rdv' | 'autre';
